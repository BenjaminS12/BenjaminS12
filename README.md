<h1 align="center"><b>Hi, I'm Benjamin Soto </b><img src="https://media.tenor.com/hVRhFeDFW6oAAAAi/anime-wave.gif" width="60"></h1>
...
<hr>
<img align="right" src="https://media1.tenor.com/m/zWLzYDsUprAAAAAC/anime-boy.gif" alt="Unfortunately I didn't find the author of the pic, feel to open a pull request if found" width="400" />

```
-------------------------
💻 Front-End Developer with interest in Cloud & DevOps  
🎓 Computer Engineering Student (INACAP – Chile)  
🛠️ Experience with React, Vite, Django, Firebase & PostgreSQL  
☁️ Learning: Azure, Docker, CI/CD, Cybersecurity  
📚 I enjoy building clean UIs and integrating cloud services  
🚀 Currently improving my DevOps & Cloud Computing skills  
🎮 Love strategy games, card games & tech challenges  
🎧 lofi · anime OSTs · chill beats while coding
-------------------------
```
## 🛠 &nbsp;Tech Stack
